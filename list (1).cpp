...
//The default constructor is used to initialize the state of your class.
...
//The destructor will de-allocate all the memory allocated to your class.
...
//new node, and key is stored in the data filed, and 0 is stored in the next field,
...
//The function, Remove, removse key from, if it is in the list, 
//from any locationanywhere (front, back, and between front and back).
