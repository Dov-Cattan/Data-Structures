...
public:
	...
	friend ostream& operator<<(ostream& out, const sentence&); //Overload the insertion operator as a friend function with chaining to print a word A;
	...
	word* Search(const string& subject);
